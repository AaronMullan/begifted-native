...
import type { CheckInConfig } from "./BetaFeedbackModal";

/**
 * Copy for the three beta feedback modals, verbatim from the hand-off
 * (Beta_Feedback_Modals_Handoff.md; Figma 5598:15522 / 5598:15575 /
 * 5598:15605). Option `value`s are the stable keys written to the
 * `beta_feedback.responses` jsonb -- don't rename them once testers have
 * submitted, or aggregation splits.
 */
export const BETA_CHECK_IN_CONFIGS: Record<BetaCheckInScreen, CheckInConfig> = {
  ...
  first_gift_set: {
    ...
    subtext:
      "You just reviewed a set of gift ideas. Help us understand how they landed.",
    selectedChipColor: "teal",
    chips: [
      {
        id: "felt_right",
